const GRAMMAR = {
  ...
  "一般将来时": {
    ...
    "desc": "表示将来要做的事情或将要发生的动作。",
    "rules": [
      "will + 动词原形：表示意愿、决定、预测等。",
      "be going to + 动词原形：表示计划、安排、迹象明显的将来。",
      "表示将来常用时间状语：tomorrow, next week, in two days 等。"
    ],
    "example": [
      "I will help you.",
    ...
    "note": "will 通常用于临时决定，be going to 通常用于事先计划好的安排。"
  },
  "过去进行时": {
    "title": "过去进行时 (Past Continuous Tense)",
    "desc": "表示在过去某一时刻正在进行的动作。",
    "rules": [
      "构成：was / were + 动词的现在分词 (v-ing)。",
      "was 用于 I, he, she, it 及单数名词；were 用于 you, we, they 及复数名词。",
      "常与过去某一时间点连用，如: at 8:00 yesterday, when..."
    ],
    "example": [
    ...
    "note": "若动作是瞬间完成的（如 start, stop），通常不用进行时。"
  },
  "现在完成时": {
    "title": "现在完成时 (Present Perfect Tense)",
    "desc": "表示动作从过去持续到现在，或对现在造成的影响。",
    "rules": [
      "构成：have / has + 过去分词 (done)。",
      "have 用于 I, you, we, they；has 用于 he, she, it。",
      "常用时间状语：already, yet, ever, never, just, so far, since + 时间点, for + 时间段。",
      "否定句常用 yet (放在句末)，疑问句常用 ever。"
    ],
    "example": [
      "I have already finished my homework.",
      "She has lived in Guangzhou for five years.",
      "Have you ever been to Shanghai?",
      "He hasn't eaten lunch yet."
    ],
    "note": "since + 时间点 (since 2010)；for + 时间段 (for three years)。"
  },
  "被动语态": {
    "title": "被动语态 (Passive Voice)",
    "desc": "当动作的承受者是句子的主语时使用。",
    "rules": [
      "构成：be + 过去分词 (done)。",
      "be 动词的时态取决于句子的基本时态（am/is/are, was/were, will be 等）。",
      "动作的发出者通常用 by + 某人 来表示。"
    ],
    "example": [
    ...
    "note": "如果动作的发出者不重要或不知道是谁，可以省略 by 部分。"
  },
  "定语从句": {
    "title": "定语从句 (Attributive Clauses)",
    "desc": "在名词后面起修饰作用的从句。",
    "rules": [
      "使用关系代词 (that, which, who) 引导。",
      "who/that 引导先行词是人的从句；which/that 引导先行词是物的从句。",
      "注意先行词在从句中是主语还是宾语。"
    ],
    "example": [
      "The man who is standing there is my teacher.",
      "I like the book that you bought me.",
      "This is the dog which lives in my house."
    ],
    "note": "当先行词是人时，通常用 who 或 that；当先行词是物时，通常用 which 或 that。"
  },
  "宾语从句": {
    "title": "宾语从句 (Object Clauses)",
    "desc": "在动词后面作宾语的从句。",
    "rules": [
      "引导词可以是 that, whether, if 或疑问词。",
      "核心规则：从句必须使用【陈述句语序】（主语在前，谓语在后），不能用疑问句语序。",
      "如果主句是现在时，从句可以用任何时态；如果主句是过去时，从句通常要进行时态回退。"
    ],
    "example": [
    ...
    "note": "在宾语从句中，不要说 'Do you know where does he live?'，要说 'Do you know where he lives?'。"
  },
  "条件状语从句": {
    "title": "条件状语从句 (Conditional Clauses)",
    "desc": "由 if 引导，表示在某种条件下会发生的事情。",
    "rules": [
      "主将从现原则：在 if 引导的条件状语从句中，用一般现在时表示将来，主句用一般将来时。",
      "unless = if...not (除非)。"
    ],
    "example": [
